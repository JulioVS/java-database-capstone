...
/*
  Note: The functions in this file are designed to interact with the backend API for doctor-related operations. 
  They handle both successful responses and errors gracefully, ensuring that the application can provide feedback to the user when something goes wrong.
*/
