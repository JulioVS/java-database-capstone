...
public class PatientService {
    ...
    @Transactional
    public int createPatient(@NonNull Patient patient) {
    ...
    // 4. **getPatientAppointments Method**:
    ...
    public ResponseEntity<Map<String, Object>> getPatientAppointments(Long id, String token) {
        ...
        try {
            ...
            return ResponseEntity.ok(Map.of("appointments", convertToDTO(appointments)));
    ...
    // Helper method to convert Appointment entities to AppointmentDTOs
    ...
    public ResponseEntity<Map<String, Object>> filterByCondition(String condition, Long id) {
        ...
        try {
            ...
            int status = convertToStatus(condition);
    ...
    // Helper method to convert condition string to status code
    private int convertToStatus(String condition) {

        if ("future".equalsIgnoreCase(condition)) {
            return 0; // Future appointments
        } else if ("past".equalsIgnoreCase(condition)) {
            return 1; // Past appointments
        } else {
