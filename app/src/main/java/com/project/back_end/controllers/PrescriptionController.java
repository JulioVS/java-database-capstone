...
public class PrescriptionController {
    ...
    public ResponseEntity<Map<String, String>> savePrescription(@RequestBody @Valid Prescription prescription,
        ...
        // Validate the token for the "doctor" role using the shared service
        ...
        // Extract the appointment ID from the prescription object
        ...
        // Update the status of the corresponding appointment to reflect that a
        // prescription has been added
        ResponseEntity<Map<String, String>> isUpdated = appointmentService.changeStatus(appointmentId, 1);
        ...
        // Save the prescription using the PrescriptionService
