...
public class PatientController {
    ...
    @PostMapping
    public ResponseEntity<Map<String, String>> createPatient(@RequestBody @NonNull Patient patient) {

        if (!service.validatePatient(patient)) {
            return ResponseEntity.badRequest().body(Map.of("error", "Invalid patient data"));
        }
