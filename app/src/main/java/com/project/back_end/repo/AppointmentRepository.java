...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
    ...
    // This repository interface is responsible for managing Appointment entities in
    // the database. It extends JpaRepository, which provides basic CRUD operations
